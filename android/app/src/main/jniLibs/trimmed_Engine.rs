//this makes up about 15% of the engine. Iv placed this here for transparency purposes, hopefully people understand how the engine works a little without exposing it. (VX-Titanium v5)
