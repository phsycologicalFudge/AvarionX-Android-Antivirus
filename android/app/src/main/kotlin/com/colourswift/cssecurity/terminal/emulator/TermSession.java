...
import com.colourswift.cssecurity.terminal.util.ByteQueue;
...
public class TermSession {
    ...
    /**
     * Inject bytes directly into the emulator's receive path as if they came
     * from the shell process.  Used by the native bridge to display AV-builtin
     * output without routing text through the shell's stdin.
     *
     * @param data   byte array to inject
     * @param offset start offset in {@code data}
     * @param count  number of bytes to inject
     */
    public void injectOutput(byte[] data, int offset, int count) {
